...
-->
            ...
            <div class="card z-index-2 h-100">
                <div class="card-header pb-10 pt-10 bg-transparent" style="background-image: url('./img/Cei-carrusel2.png');
                    ...
                    <p class="text-sm mb-0">
                        ...
                        <span class="font-weight-bold">MiPyMES</span> in 2021
                    </p>
                </div>
                <!--
                    <div class="card-body p-3" >
    ...
    <!--SALES BY COUNTRY AND CATEGORIES
        <div class="row mt-4">
            <div class="col-lg-7 mb-lg-0 mb-4">
                <div class="card ">
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js-na1.hs-scripts.com/23194622.js"></script>
<!-- End of HubSpot Embed Code -->
<!-- Código de instalación Cliengo para https://consultoria-cei.netlify.app -->
<!--
<script type="text/javascript">
    (function() {
        ...
        ldk.async = true;
        ldk.src = 'https://s.cliengo.com/weboptimizer/63548f62cced3b002a5e5748/635491f4cced3b002a5e5850.js?platform=view_installation_code';
        var s = document.getElementsByTagName('script')[0];
        s.parentNode.insertBefore(ldk, s);
    })();
</script>-->
<!-- End of cliengo embed Code -->
...
<script>
    ...
    gradientStroke1.addColorStop(1, 'rgba(242, 39, 134, 0.2)');
    gradientStroke1.addColorStop(0.2, 'rgba(242, 39, 134, 0.0)');
    gradientStroke1.addColorStop(0, 'rgba(242, 39, 134, 0)');
    new Chart(ctx1, {
        type: "line",
        data: {
